...
import thread from "./routes/threads.js";
...
import createTodaysFirstMessage from "./helpers/createTodaysFirstMe.js";
...
io.on("connection", (socket) => {
  ...
  socket.on("user-join", async ({ id, isOnline }) => {
    ...
    console.log('user tried to join');
  });
  ...
  // Channel and Conversation Handling:
  ...
  // Message View and Reaction Handling
